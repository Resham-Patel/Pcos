...
const HormoneBalanceAwareness = () => {
  return (
    <div className="hormone-page">
      ...
      <section className="hormone-section">
        <div className="section-heading">
          <h2>Simple daily rhythm</h2>
          <p>
            A supportive routine does not have to be perfect. Small steps done
            consistently can be more realistic than extreme changes.
          </p>
        </div>

        <div className="routine-grid">
          <div className="routine-card">
            <div className="routine-time">Morning</div>
            <p>
              Start with water, light movement, and a nourishing breakfast with
              protein and fiber.
            </p>
          </div>

          <div className="routine-card">
            <div className="routine-time">Afternoon</div>
            <p>
              Choose a balanced lunch and take short movement breaks instead of
              staying seated for long hours.
            </p>
          </div>

          <div className="routine-card">
            <div className="routine-time">Evening</div>
            <p>
              Go for a gentle walk, stretching session, or other low-impact
              activity that feels sustainable.
            </p>
          </div>

          <div className="routine-card">
            <div className="routine-time">Night</div>
            <p>
              Create a calmer wind-down routine with lighter screen use and
      ...
      <section className="hormone-cta">
        <div className="hormone-cta-content">
          ...
          <button className="hormone-primary-btn">
